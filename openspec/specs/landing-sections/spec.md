...
The four content sections rendered directly from the design — Hero, Services, About, and
Contact — including their typography, two-tone headings, atmospheric hero background, and the
experience timeline. Projects is deliberately excluded; it has its own capability because it
departs from the design and carries real behaviour.
